...
const GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Caixa", to: "/cashbox" },
      { label: "Recebimentos", to: "/finance/payments" },
      { label: "A Receber", to: "/finance/receivables" },
      { label: "Confirmações Pendentes", to: "/finance/pending" },
      { label: "Reconciliação", to: "/finance/reconciliation" },
      { label: "Créditos de Cliente", to: "/finance/credits" },
      { label: "Contas a Pagar", to: "/finance/payables" },
      { label: "Entregas e Caixa", to: "/finance/handovers" },
      { label: "Diários", to: "/finance/journals" },
