...
const GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "— A Receber —", to: "#", disabled: true } as any,
      ...
      { label: "— A Pagar —", to: "#", disabled: true } as any,
      { label: "Contas a Pagar", to: "/finance/payables" },
      { label: "Despesas Fixas", to: "/finance/recurring" },
      { label: "— Banco / Caixa —", to: "#", disabled: true } as any,
      ...
      { label: "— Configuração —", to: "#", disabled: true } as any,
