...
export const MODULES: ModuleDef[] = [
  {
    ...
    menu: [
      ...
      { section: "Vendas", label: "Cronograma de Entregas", to: "/sales/delivery-schedule" },
      ...
      { section: "Relatórios", label: "Margem por Venda", to: "/reports/margins" },
    ],
  },
  {
    id: "purchase",
  ...
  },
  {
    ...
    menu: [
      ...
      { section: "Operações", label: "Expedições", to: "/inventory/shipments" },
      { section: "Operações", label: "Transferências", to: "/inventory/transfers" },
      { section: "Operações", label: "Transferências internas", to: "/inventory/internal-transfers" },
      { section: "Operações", label: "Backorders", to: "/inventory/backorders" },
  ...
  },
  {
    ...
    menu: [
      ...
      { section: "Operações", label: "Conciliação Bancária", to: "/finance/reconciliation" },
      { section: "Operações", label: "Créditos de Cliente", to: "/finance/credits" },
  ...
  },
  {
    ...
    menu: [
      ...
      { section: "Configuração", label: "Máquinas", to: "/manufacturing/machines" },
      { section: "Engenharia", label: "Listas de Materiais (BOM)", to: "/products/bom" },
    ],
  },
  {
