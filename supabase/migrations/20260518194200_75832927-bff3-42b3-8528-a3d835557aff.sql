...
BEGIN
  ...
  INSERT INTO public.sale_orders(name, partner_id, state) VALUES (v_pfx||'SO-A', v_cust, 'sale'::sale_state) RETURNING id INTO v_so;
  INSERT INTO public.sale_orders(name, partner_id, state) VALUES (v_pfx||'SO-B', v_cust2, 'sale'::sale_state) RETURNING id INTO v_so2;
