...
BEGIN
  ...
  BEGIN
    ...
    SELECT product_variant_id INTO v_pn_variant
      FROM purchase_needs
     WHERE manufacturing_order_id = v_mo AND product_id = v_tecido LIMIT 1;
  ...
  BEGIN
    ...
    passed := v_q01_qty = 100 AND v_q02_qty = 94;
  ...
  BEGIN
    ...
    PERFORM create_purchase_need(v_tecido, 5, 'manual'::purchase_need_origin,
