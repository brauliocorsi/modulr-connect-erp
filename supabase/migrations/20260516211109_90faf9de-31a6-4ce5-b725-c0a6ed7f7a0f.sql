...
-- Aplicar substituição via redefinir só os trechos que falham — re-executando definição completa com correção.
-- Usar UPDATE no source não é possível, vou redefinir a função inteira com a coluna correta:
