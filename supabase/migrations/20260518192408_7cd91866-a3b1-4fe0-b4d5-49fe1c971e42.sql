...
DECLARE
  ...
  v_health jsonb;
BEGIN
  -- SETUP: 2 customers, 2 sale orders
  INSERT INTO public.partners(name, kind, is_customer) VALUES (v_pfx||'CustA','person',true) RETURNING id INTO v_cust;
  INSERT INTO public.partners(name, kind, is_customer) VALUES (v_pfx||'CustB','person',true) RETURNING id INTO v_cust2;
  INSERT INTO public.sale_orders(name, partner_id, state) VALUES (v_pfx||'SO-A', v_cust, 'sale'::sale_order_state) RETURNING id INTO v_so;
  INSERT INTO public.sale_orders(name, partner_id, state) VALUES (v_pfx||'SO-B', v_cust2, 'sale'::sale_order_state) RETURNING id INTO v_so2;
  ...
  -- 02: token guardado em hash, puro não fica
  ...
  -- 03: token válido consulta order_status
  ...
  -- 05: token da SO-A não acessa SO-B (criar token para CustB e tentar acessar SO-A via mismatch)
  ...
  -- 08: cliente attachment metadata
  ...
  -- 10: Help Desk nota interna não fica como pública
  ...
  -- 11: damaged_product converte para service_case
  ...
  -- 13: service_case ligado (já checado em 11, reforço com case_number)
  ...
  -- 14: customer_service_case_status público
  ...
  -- 15: general_question NÃO converte automaticamente
  ...
  -- 16: pedido de agendamento cria ticket
  ...
  -- 17: fechar ticket (general_question) preserva histórico
  ...
  -- 18: health check detecta ticket aberto há muito tempo
  -- Cria ticket antigo manipulando created_at
  ...
  -- 19: health check detecta assistência não convertida
