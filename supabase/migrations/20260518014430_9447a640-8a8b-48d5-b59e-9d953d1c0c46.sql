...
DECLARE
  ...
  v_user uuid := '00000000-0000-0000-0000-0000000c0ffe'::uuid;  -- PATCH P03: fake test user
BEGIN
  ...
  -- PATCH P03: inject fake jwt sub so auth.uid() resolves inside register_customer_payment trigger.
  ...
  BEGIN
    ...
    -- PATCH P12: use CURRENT_DATE+2 to avoid collision with route_a's unique (zone_id, route_date).
    INSERT INTO delivery_routes(route_date, vehicle_id, zone_id, state, notes)
