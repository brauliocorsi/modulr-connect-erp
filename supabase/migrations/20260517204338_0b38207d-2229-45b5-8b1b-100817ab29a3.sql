...
CREATE OR REPLACE FUNCTION public._test_purchase_need_to_po_flow_scenario4_fix() RETURNS void
LANGUAGE sql AS $$ SELECT 1 $$;
DROP FUNCTION public._test_purchase_need_to_po_flow_scenario4_fix();

-- Patch only the offending block via full re-create
...
BEGIN
  ...
  DECLARE
    ...
    v_sm_variant uuid; v_negative_count int;
    v_pn_count int; v_po_count int;
  BEGIN
