...
BEGIN
  ...
  -- Finished good: always bump quantity only. Reservation for sale_active SOL
  -- happens via the natural replan triggered when MO state goes to 'done'.
  ...
  -- Reservation log with case-specific payload (always logged)
