...
DECLARE
  ...
  p_buy uuid; p_mfg uuid; comp uuid; bom_id uuid;
  so_a uuid; def_a uuid;
  so_d uuid; def_d uuid;
  so_e uuid; def_e uuid;
  so_f uuid; def_f uuid;
  def_g1 uuid;
  before_needs int; after_needs int; after_pays int;
...
BEGIN
  ...
  INSERT INTO customer_payments(name,order_id,amount,payment_date,state) VALUES(pfx||'PAYD',so_d,40,CURRENT_DATE,'posted');
  ...
  INSERT INTO customer_payments(name,order_id,amount,payment_date,state) VALUES(pfx||'PAYE',so_e,20,CURRENT_DATE,'posted');
