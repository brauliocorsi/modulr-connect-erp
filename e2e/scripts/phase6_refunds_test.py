...
cur.execute("SELECT _test_phase6()")
res=cur.fetchone()[0]; asserts=res["asserts"]; fails=0
rep=["# Phase 6 — Refunds report",f"_run: {datetime.datetime.utcnow().isoformat()}_","",
     "| # | Step | OK | Observed |","|---|---|---|---|"]
...
with open("/mnt/documents/phase6-refunds-report.md","w") as f: f.write(out)
print("\n"+out)
