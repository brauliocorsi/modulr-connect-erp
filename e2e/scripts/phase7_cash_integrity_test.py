#!/usr/bin/env python3
"""PHASE 7 — Cash session integrity."""
...
cur.execute("SELECT _test_phase7()")
res=cur.fetchone()[0]; asserts=res["asserts"]; fails=0
rep=["# Phase 7 — Cash session integrity report",f"_run: {datetime.datetime.utcnow().isoformat()}_","",
     "| # | Step | OK | Observed |","|---|---|---|---|"]
...
with open("/mnt/documents/phase7-cash-integrity-report.md","w") as f: f.write(out)
print("\n"+out)
